    ...
    private fun getListQuotes() {
        ...
        client.get(url, object : AsyncHttpResponseHandler() {
            override fun onSuccess(statusCode: Int, headers: Array<Header>, responseBody: ByteArray) {
                ...
                try {
                    /*
                    Karena dimulai dengan [ ], artinya ia bertipe JSONArray. Karena itu, untuk mengambil datanya kita menggunakan ini
                     */
                    val jsonArray = JSONArray(result)
                    // melakukan perulangan untuk mendapatkan data JSONObject
                    ...
                    /*
                    Setelah mendapatkan data dalam bentuk ArrayList, maka Anda dapat memasukkannya ke adapter RecyclerView
                     */
